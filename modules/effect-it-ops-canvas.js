...
(function(){
  const DEFAULT_OFFERS = [
    { brand:'Tiandy', text:'باقة Tiandy: ٤ كاميرات + NVR ٤ قنوات + هارد ١ تيرا بـ 6,000 ر.س بدل 7,800 (وفّر 1,800)', short:'باقة Tiandy 6,000 ر.س بدل 7,800' },
    { brand:'Hikvision', text:'باقة Hikvision منزلية: كاميرتين + NVR بـ 4,250 ر.س بدل 5,100 (وفّر 850)', short:'باقة Hikvision 4,250 ر.س بدل 5,100' },
    { brand:'Ruijie', text:'راوتر Ruijie Enterprise + نقطة وصول بـ 3,100 ر.س بدل 3,650 (وفّر 550)', short:'راوتر Ruijie 3,100 ر.س بدل 3,650' }
  ];
