    ...
    <div class="prod-card" data-cat="${categoryAccentKey(p)}" onclick="openProductDetail('${p.id}')" style="cursor:pointer;">
      ...
      <div class="prod-body">
        ...
        <div class="prod-price-row">
          <span class="prod-price">${Number(p.price).toLocaleString('ar-SA')} ر.س</span>
          ${discount ? `<span class="prod-old">${Number(p.old_price).toLocaleString('ar-SA')} ر.س</span>` : ''}
        </div>
    ...
    <div class="qv-grid">
      ...
      <div class="qv-body">
        ...
        <div class="qv-price-row">
          <span class="qv-price">${Number(p.price).toLocaleString('ar-SA')} ر.س</span>
          ${discount ? `<span class="qv-old">${Number(p.old_price).toLocaleString('ar-SA')} ر.س</span>` : ''}
        </div>
  ...
  el.innerHTML = `
    ...
    <div>
      ...
      <div class="pd-price-row">
        <span class="pd-price">${Number(p.price).toLocaleString('ar-SA')} ر.س</span>
        ${discount ? `<span class="pd-old">${Number(p.old_price).toLocaleString('ar-SA')} ر.س</span>` : ''}
      </div>
...
function renderPriceFilter(){
  ...
  document.getElementById('priceMaxInput').placeholder = maxP.toLocaleString('ar-SA');
}
...
function renderCompareTable(){
  ...
  const fields = [
    ...
    {key:'price', label:'السعر', fmt:v=>v?`${Number(v).toLocaleString('ar-SA')} ر.س`:'-'},
