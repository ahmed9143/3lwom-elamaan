...
function renderRackBuilder(){
  ...
  const monthlyCost = Math.round((totalWatts/1000) * 24 * 30 * 1.75); // ~1.75 ر.س/kWh placeholder tariff — for guidance only
  ...
  calcHost.innerHTML = `
    ...
    <div class="rack-calc-card"><div class="v">~${monthlyCost.toLocaleString('ar-SA')} ر.س</div><div class="l">💡 تكلفة كهرباء شهرية تقديرية</div></div>
  `;
