...
const FINDER_STEPS = [
  ...
  { key:'budget', title:'الميزانية التقريبية لكل كاميرا', sub:'تقدير مبدئي - السعر النهائي بيختلف حسب الماركة والمواصفات', options:[
      {value:'economy', icon:'💰', label:'اقتصادي (حتى 1500 ر.س)'},
      {value:'mid', icon:'💵', label:'متوسط (1500 - 3000 ر.س)'},
      {value:'premium', icon:'💎', label:'متقدم (أكتر من 3000 ر.س)'},
...
const FINDER_LABELS = {
  ...
  budget:{economy:'اقتصادي (حتى 1500 ر.س)',mid:'متوسط (1500-3000 ر.س)',premium:'متقدم (أكتر من 3000 ر.س)',any:'بدون حد محدد'}
};
